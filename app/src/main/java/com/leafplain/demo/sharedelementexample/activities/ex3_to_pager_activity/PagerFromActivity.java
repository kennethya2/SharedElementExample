...
public class PagerFromActivity extends AppCompatActivity
    ...
    private PagerFromActivity context;
...
//
//
        mRecyclerSamplePresenter = new RecyclerSamplePresenter(PagerFromActivity.this);
    ...
    private void showPager(int pos, ImageView view, String transitionName){
        ...
        Intent intent = new Intent(context, PagerToActivity.class);
